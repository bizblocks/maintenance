...
войти в систему, а лишь видят заранее подготовленную страницу, в отличии от администраторов и специальных пользователей, которые могут ввойти в систему, введя
...
2. На данном экране можно включит/выключит данный режим. Задать страницу показа, роль пользователей которые могут входит в систему в активированном режиме, а так же задать специальный параметр входа
...
И если пользователь не является администратором системы (нет роли у данного пользователя) или не имеет специальной назначенной роли, вход в систему для него будет невозможен.
